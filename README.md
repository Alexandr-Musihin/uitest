...
│   ├── test_auth_flow.py       # Основной тест авторизации
│   ├── conftest.py            # Конфигурация pytest
│   └── 📁 pages/              # Page Objects (опционально)
│       └── login_page.py
├── 📁 reports/                 # Отчеты и артефакты
│   ├── report.html
│   ├── junit.xml
│   └── 📁 screenshots/
...
![Пример отчета](https://via.placeholder.com/800x400.png?text=HTML+Report+Example)

## 🎥 Демо

### Скринкаст работы тестов:
